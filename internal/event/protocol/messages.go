...
// main reason this file defines its own protocol framing.
package protocol
...
func NewHello(pid int, eventKeys []string, params map[string]string, openIDHash, version, traceID string) *Hello {
	return &Hello{
		Type:       MsgTypeHello,
		PID:        pid,
		EventKeys:  eventKeys,
